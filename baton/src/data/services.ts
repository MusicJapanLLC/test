...
export const services: Service[] = [
  ...
  },
  {
    ...
    company: '株式会社unveil',
    serviceName: 'unveil',
    tagline: 'ブランドや商品にある価値を、一緒に見つけて、かたちにする',
    description:
      '大阪を拠点に、Web制作・ブランディング・採用・コンテンツマーケティング・プロダクト開発支援まで、企業や地域が持つ魅力を言語化し形にするクリエイティブカンパニー。代表・古谷祐麻が伴走支援します。',
    theme: { primary: '#6B3FA0', accent: '#A487D9', bg: '#FAF7FC', text: '#241A33' },
    monument: 'lattice',
    problems: [
      { title: '会社の魅力が言葉になっていない', detail: '強みや世界観をうまく言語化できずにいる' },
      { title: 'Web・採用・広報がバラバラ', detail: 'サイト・採用・発信がそれぞれ別々に動いている' },
      { title: '採用がうまくいかない', detail: '応募が集まらない、求める人材に届かない' },
      { title: '商品や地域の価値が伝わらない', detail: '良いものがあるのに認知や販売につながらない' },
    ],
    features: [
      { title: 'Web制作', detail: 'コーポレート・採用・LP・サービスサイトをUI/UXまで一貫設計' },
      { title: 'ブランディング', detail: '企業・商品・地域にある価値を整理し、コンセプトから設計' },
      { title: '採用支援', detail: 'ペルソナ設計から求人原稿・媒体連携までワンストップ対応' },
      { title: 'コンテンツマーケティング', detail: 'SEO・記事設計からリード獲得・集客まで対応' },
      { title: '撮影・グラフィック', detail: '写真・動画のディレクション、ロゴ・販促物のデザイン' },
      { title: 'プロダクト・運用支援', detail: '商品開発支援からCMS・サーバー運用、業務改善まで' },
    ],
    strengths: [
      { title: 'デザインで終わらない一貫対応', detail: '魅力の言語化からコンセプト設計・撮影・SEO・運用設計まで' },
      { title: '採用は戦略設計から', detail: 'ペルソナ設計→採用戦略→求人原稿→媒体連携→クリエイティブまで対応' },
      { title: '商品・地域ブランディングの実績', detail: 'モノ・コト・場所にある価値をかたちにするプロジェクトに参画' },
      { title: '代表が直接伴走', detail: '国内外のプロジェクト経験を持つ代表・古谷祐麻が支援を担当' },
    ],
    stats: [
      {
        label: '採用支援の成果',
        value: '100',
        unit: '名応募（6ヶ月）',
        note: '大阪の税理士事務所の採用戦略・求人原稿支援で、有資格税理士の採用に成功',
      },
      {
        label: 'サイト改善の成果',
        value: '5.5',
        unit: '万PV（30日間）',
        note: '全国展開の便利屋サービスのSEO・導線改善で、平均ユーザー1.9万人を記録',
      },
      {
        label: '対応領域',
        value: '10',
        unit: '分野以上',
        note: 'Web・UI/UX・ブランディング・採用・SEO・撮影・グラフィック・市場調査・運用・業務改善など',
      },
    ],
    links: [],
    survey: {
      questions: [
        ...
        },
        {
          ...
          type: 'multi',
          options: [
            '会社やブランドの魅力をうまく言葉にできていない',
            'Web・採用・広報がバラバラに動いている',
            '採用の応募が集まらない',
            '商品や地域の価値をうまく伝えられていない',
            '何から手をつけるか決まっていない',
          ],
        },
        {
          ...
          label: '検討している時期はいつ頃ですか',
          type: 'single',
          options: ['今すぐ', '1ヶ月以内', '3ヶ月以内', '半年以内', '情報収集の段階'],
        },
        {
          id: 'q4',
          label: '想定している予算はどのくらいですか',
          type: 'single',
          options: ['〜30万円', '30〜100万円', '100〜300万円', '300万円以上', 'これから検討'],
        },
      ],
      profileFields: BASE_PROFILE,
    },
