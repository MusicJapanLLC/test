#!/usr/bin/env python3
"""Build the durable WORLD trust-root checkpoint from existing production evidence."""
...
from engine.world_trust_root_runtime import build_world_trust_root_checkpoint  # noqa: E402
...
def main() -> int:
    ...
    checkpoint = build_world_trust_root_checkpoint(
