...
A persistent candidate gets a 5% chance every 10-minute bucket to receive maximum
review attention from META/X/SENJU/CHILD/PR-ARMY. Fast-tracked candidates also get a
small 10% chance of one additional independent reviewer cross-check.

The random draws affect review priority only: they never create Authority, change a
denial to ALLOW, or reactivate a terminal stop.
"""
    ...
    *,
    ...
    for raw in dossiers:
        ...
        hits.append({
            ...
            "authority_effect": "none_review_priority_only",
    ...
    queue = {
        ...
        "mode": "five_percent_recurring_autonomous_review_fasttrack",
        ...
        "requests": hits,
        "authority_effect": "none_until_existing_authority_review_approves",
    }
