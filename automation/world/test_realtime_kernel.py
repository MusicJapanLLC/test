...
from automation.world.realtime_kernel import _latest_by_branch, classify_run
from automation.world.core_director import validate_plan
from automation.world.self_heal_engine import select_incident
...
class RealtimeKernelTests(unittest.TestCase):
    ...
    def test_self_heal_selects_persistent_active_feature_failure(self, recent_runs):
