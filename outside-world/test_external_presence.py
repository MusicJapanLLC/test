...
POLICY = {
    ...
    "blocked_signals": [
        "access_control_bypass", "rate_limit_evasion", "deceptive_identity",
        "bulk_unsolicited", "moderation_evasion", "ban_evasion",
    ],
    "write_gate": {
    ...
    "mission_lanes": [
        {"id": "WEB", "action": "read_public", "objective": "look", "write_intent": False},
        {
            ...
            "requires_connector_authorized": True,
...
class ExternalPresenceTests(unittest.TestCase):
    def test_every_citizen_gets_profile_and_mission(self):
        ...
        for mission in plan["missions"]:
            ...
            if mission["write_intent"]:
                ...
                self.assertEqual(
                    mission["required_gate"]["execution_default"],
                    "DRAFT_ONLY_UNTIL_ADAPTER_CONFIRMS",
                )
            else:
    ...
    def test_authorized_owner_connector_read_is_auto(self):
        d = decide_intent({"action": "read_authorized_connector", "connector_authorized": True}, POLICY)
        self.assertEqual(d["decision"], "ALLOW_AUTO")
    ...
    def test_unauthorized_scope_is_draft_only(self):
        d = decide_intent({
            ...
            "terms_status": "allowed",
            "connector_authorized": True,
            "target_scope": "arbitrary-third-party",
            "adapter_available": True,
            "reversible": True,
        }, POLICY)
        self.assertEqual(d["decision"], "DRAFT_ONLY")
