...
from senju.opposition_force import run_live_opposition_force, verify_live_bindings
...
def test_live_opposition_force_json_is_machine_readable() -> None:
    ...
    assert payload["schema"] == "senju-live-opposition-force/v1"
    assert payload["mode"] == "real-implementation-bindings"
