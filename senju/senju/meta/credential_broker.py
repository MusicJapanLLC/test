...
META may select and lease capabilities that were explicitly registered ahead of
runtime. The broker never scans for secrets, reads raw token material, adds OAuth
scopes, creates administrators, or exports credentials. State contains only
opaque credential references and capability scopes.
"""
