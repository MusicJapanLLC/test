...
META may autonomously select, lease, and delegate capability handles registered
before runtime. It never scans for secrets, reads raw token material, adds OAuth
