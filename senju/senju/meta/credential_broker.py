"""Autonomous pre-authorized credential capability broker for META.

META can discover registered capability metadata, select the least-privilege
...
HEALTH_FILE = ROOT / "senju" / "state" / "meta_credential_health.json"
